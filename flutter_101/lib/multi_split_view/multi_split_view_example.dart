...
import 'package:flutter_101/bottom_sheet/bottom_sheet.dart';
...
class MultiSplitViewExampleState extends State<MultiSplitViewExample> {
  ...
  late final List<RandomColorBox> _boxes =
      List.generate(_initial, (_) => _createBox());
  ...
  Widget build(BuildContext context) {
    ...
    MultiSplitViewTheme theme = MultiSplitViewTheme(
        data: MultiSplitViewThemeData(
            dividerPainter: DividerPainters.grooved1(size: 50, thickness: 4)),
